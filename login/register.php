...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-6 text-center">Registro de nuevo usuario</h2>
        ...
        <?php if (isset($_SESSION['registro_exito'])): ?>
            <div class="bg-green-100 dark:bg-green-900 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-200 px-4 py-3 rounded mb-4">
                <?php echo $_SESSION['registro_exito']; unset($_SESSION['registro_exito']); ?>
            </div>
        <?php endif; ?>

        <form action="procesar-register.php" method="POST" class="space-y-4">
            <div>
            ...
            <div>
                <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" for="telefono">Teléfono:</label>
                <input 
                    type="text" 
                    name="telefono" 
                    id="telefono"
            ...
            <div>
                <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" for="direccion">Dirección:</label>
                <input 
                    type="text" 
                    name="direccion" 
                    id="direccion"
            ...
            <button 
                type="submit" 
                class="w-full bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-150 mt-4"
            >
                Registrarse
            </button>
        </form>
        ...
        <div class="flex justify-between items-center mt-4">
            <p class="text-gray-600 dark:text-gray-400">
                ¿Ya tenés cuenta? 
                <a href="login.php" class="text-blue-500 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium">Iniciar sesión</a>
            </p>
